...
HD_PWD='C:/Users/gao/Desktop/Computer-Orgnization-ARM-/Project/10.CPU_Mem/CPU_Mem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_CPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_CPU.tcl -notrace
