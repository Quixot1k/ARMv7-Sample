...
module regFile_2(clk,
    ...
    input clk;
    input Rst;
    input Write_Reg, Write_PC;
    input [5:1] M;
    input [ADDR:1] R_Addr_A, R_Addr_B, R_Addr_C;
    input [ADDR:1] W_Addr;
    input [SIZE:1] W_Data,PC_New;
    
    output reg [SIZE:1] R_Data_A, R_Data_B, R_Data_C, R_Data_PC;

    reg [SIZE:1] R[0:14],R_fiq[8:14],R_irq[13:14],R_abt[13:14],R_svc[13:14],R_und[13:14],R_mon[13:14],R13_hyp, PC;
    integer i;
    reg err;
