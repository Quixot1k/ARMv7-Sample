...
HD_PWD='C:/Users/GAO/Desktop/Computer-Orgnization/Project/barrelShifter/barrelShifter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log barrelShifter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source barrelShifter.tcl -notrace
