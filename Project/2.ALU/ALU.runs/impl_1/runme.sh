...
HD_PWD='C:/Users/GAO/Desktop/Computer-Orgnization-ARM-/Project/2.ALU/ALU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_Board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ALU_Board.tcl -notrace
